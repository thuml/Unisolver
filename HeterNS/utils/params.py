...
def get_args():
    ...
    parser.add_argument('--z', default=1, type=int, help='input data width')
    ...
    parser.add_argument('--step-size', default=10, type=int, help='interval of model save')
    ...
    parser.add_argument('--model-pretrain-path', default=None, type=str, help='model pretrain name')

    # phase
    parser.add_argument('--evaluation', default=0, type=int, help='eval or not')
    parser.add_argument('--fast-test', default=0, type=int, help='fast test or not')
    parser.add_argument('--zero-shot', default=0, type=int, help='zero-shot adaption or not')
    parser.add_argument('--multi-scale-training', default=1, type=int, help='use multiscale training or not')
    
    parser.add_argument('--scheduler', type=str, default='cosine')
    parser.add_argument('--maxup_ratio', type=float, default=0.1)
    parser.add_argument('--maxup', type=int, default=1)
