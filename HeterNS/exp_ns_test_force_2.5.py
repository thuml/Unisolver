...
test_data = np.load(os.path.join(args.data_path, 'results_save_200/ns_vis_nu1e-05_m_2.5_u_200.npy'))
...
f = np.load(os.path.join(args.data_path, 'results_save_200/ns_vis_nu1e-05_m_2.5_f_200.npy'))
